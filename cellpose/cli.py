...
def get_arg_parser():
    ...
    # misc settings
    parser.add_argument(
        "--version", action="store_true", help="show cellpose version info"
    )
    parser.add_argument(
        "--verbose",
        action="store_true",
    ...
    input_img_args.add_argument(
        "--chan", default=0, type=int, help="Deprecated in v4.0.1+, not used. "
    )
    input_img_args.add_argument(
        "--chan2", default=0, type=int, help="Deprecated in v4.0.1+, not used. "
    )
    input_img_args.add_argument(
        "--invert", action="store_true", help="Deprecated in v4.0.1+, not used. "
    )
    input_img_args.add_argument(
        "--all_channels", action="store_true", help="Deprecated in v4.0.1+, not used. "
    )
    ...
    model_args.add_argument(
        "--chan2_restore", action="store_true", help="Deprecated in v4.0.1+, not used. "
    )
    model_args.add_argument(
        "--transformer",
        action="store_true",
    ...
    algorithm_args.add_argument(
        ...
        default=None,
        type=float,
        help="use to resize cells to the training diameter (30 pixels)",
    )
    algorithm_args.add_argument(
        "--stitch_threshold",
        required=False,
    ...
    output_args.add_argument(
        "--save_png", action="store_true", help="save masks as png"
    )
    output_args.add_argument(
        "--save_tif", action="store_true", help="save masks as tif"
    )
    output_args.add_argument(
        "--output_name",
        default=None,
    ...
    training_args.add_argument(
        "--train_size", action="store_true", help="Deprecated in v4.0.1+, not used. "
    )
